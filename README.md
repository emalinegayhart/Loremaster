...
- ~~Adding ELSER sparse vector search alongside the existing keyword search using RRF (Reciprocal Rank Fusion) to combine rankings, improving retrieval on conceptual and semantic queries.~~ [(done!)](https://github.com/emalinegayhart/Loremaster/issues/11)
